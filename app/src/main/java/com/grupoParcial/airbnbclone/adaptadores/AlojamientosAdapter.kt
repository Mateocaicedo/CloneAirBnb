...
class AlojamientosAdapter(
    val alojamientos: List<Alojamientos>, private val listener: OnItemCLick
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.resultados_search, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.direccion.text = alojamientos[position].Direccion
